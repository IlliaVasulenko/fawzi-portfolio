          ...
          >
            <div>
              ...
              <div className="space-y-6">
                <a href="mailto:fawzi.barakat728@outlook.com" className="flex items-center gap-4 p-4 rounded-lg bg-card border border-border/50 hover:border-primary/50 transition-colors group">
                  <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">Email</p>
                    <p className="font-medium">fawzi.barakat728@outlook.com</p>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4 p-4 rounded-lg bg-card border border-border/50">
                  ...
                  <div>
                    ...
                    <p className="font-medium">Sheridan, NB, United States</p>
                  </div>
                </div>
              </div>
            </div>
