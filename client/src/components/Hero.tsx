        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-bold leading-tight mb-6 tracking-tight">
              ...
              <span className="block text-primary">Fawzi Barakat</span>
            </h1>
            ...
            <div className="flex items-center gap-6">
              <a
                href="https://www.linkedin.com/in/fawzi-8ab528234/"
                target="_blank"
              ...
              <a
                href="mailto:fawzi.barakat728@outlook.com"
                className="text-muted-foreground hover:text-primary transition-colors hover:-translate-y-1 transform duration-200"
              >
          ...
          >
            <p className="text-lg md:text-xl text-muted-foreground mb-12 leading-relaxed font-light">
              I am a Senior Full Stack & AI Developer with 7+ years of experience building scalable web, mobile, and AI-powered applications. I specialize in Python backend development using Django, Flask, and FastAPI, combined with Node.js for high-performance, modern architectures.
