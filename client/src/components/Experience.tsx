...
const experiences = [
  ...
  },
  {
    ...
    role: "Full Stack & AI Developer|DevOps | AI Automation| Python Django|",
    company: "Extern Labs Inc",
    location: "Sheridan, Wyoming, US",
    skills: ["Python", "Node.js", "React", "Next.js", "FastAPI", "Express.js", "LLMs", "RAG Pipelines", "Vector Databases", "AWS", "Docker", "DevOps", "PostgreSQL"],
    description: "Full Stack & AI Development. Led end-to-end full-stack development using Python (Django, Flask, FastAPI) and Node.js. Designed and implemented secure, scalable REST APIs and backend architectures. Built modern frontend applications with React and Next.js. Integrated AI/LLM solutions (ChatGPT / OpenAI API) into production systems. Developed AI automation workflows to optimize business processes. Collaborated on cloud deployment, performance optimization, and system scalability."
  },
  {
    period: "June 2020 - Oct 2023",
    role: "AI Mobile App Developer | iOS & Android (ChatGPT, APIs)",
    company: "Extern Labs Inc",
    location: "Sheridan, Wyoming, US",
    skills: ["Python", "Node.js", "React", "Next.js", "FastAPI", "Express.js", "LLMs", "RAG Pipelines", "Vector Databases", "AWS", "Docker", "DevOps", "PostgreSQL"],
    description: "Mobile Development.Developed AI-powered mobile applications using React Native and Flutter. Delivered cross-platform apps for iOS and Android with shared, scalable codebases. Integrated ChatGPT / LLM APIs for in-app chatbots and AI assistants. Built and consumed secure backend APIs for mobile functionality. Implemented real-time features such as chat, notifications, and live updates. Optimized app performance, scalability, and user experience. Managed app builds, testing, and deployment to App Store and Google Play."
  },
