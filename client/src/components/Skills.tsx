            ...
            <div className="grid md:grid-cols-2 gap-0 relative">
                ...
                <div className="p-10 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl hover:border-primary/30 transition-all shadow-xl relative z-20 md:mb-8">
                    <div className="flex justify-between items-baseline mb-4">
                      ...
                      <span className="text-primary font-bold bg-primary/10 px-4 py-1 rounded-full text-xs tracking-wider uppercase">2016-2019</span>
                    </div>
                    <p className="text-xl font-medium mb-1 text-foreground">Information Technology</p>
                    <p className="text-muted-foreground text-sm uppercase tracking-wider font-light">Sheridan College</p>
                </div>
            </div>
        </motion.div>
      </div>
